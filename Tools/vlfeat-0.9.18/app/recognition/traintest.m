...
diary(opts.diaryPath) ; diary off ;
...
if exist(opts.imdbPath)
 ...
 switch opts.dataset
   ...
   case 'scenes15', imdb = setupScenes15(opts.datasetDir, 'lite', opts.lite) ;
...
% descrs = ScSPMencoderImage(encoder, fullfile(imdb.imageDir, imdb.images.name), 'cacheDir', opts.cacheDir);
% descrs = LLcSPMencoderImage(encoder, fullfile(imdb.imageDir, imdb.images.name), 'cacheDir', opts.cacheDir);
descrs = LassoSPMencoderImage(encoder, fullfile(imdb.imageDir, imdb.images.name), 'cacheDir', opts.cacheDir);
